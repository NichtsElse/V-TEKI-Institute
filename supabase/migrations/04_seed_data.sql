...
-- Public/main functions: Idempotent INSERT/UPSERT blocks for demo vi_organizations, users, catalog, learning activity, and outcomes.
...
-- 1. Organizations
INSERT INTO vi_organizations (id, name, industry, contact_email) VALUES
...
INSERT INTO vi_users_profile (id, email, full_name, role, phone, status, password, created_date, organization_id, organization_name) VALUES
...
-- 3. Trainers
INSERT INTO vi_trainers (id, full_name, email, title, expertise, experience_years, status) VALUES
...
-- 4. Programs
INSERT INTO vi_programs (id, name, code, description, program_type, delivery_mode, duration_hours, price, capacity, status, category, level, passing_score, min_attendance_pct) VALUES
...
-- 5. Batches
INSERT INTO vi_batches (id, name, program_id, trainer_id, trainer_name, program_name, start_date, end_date, status, capacity, enrolled_count) VALUES
...
-- 6. Invoices
INSERT INTO vi_invoices (id, invoice_number, organization_id, organization_name, total_amount, status, due_date) VALUES
...
-- 7. Enrollments
INSERT INTO vi_enrollments (id, batch_id, participant_id, full_name, email, organization_id, organization_name, program_id, program_name, batch_name, status, enrollment_status, completion_status, invoice_id, payment_status, attendance_percentage, pre_assessment_status, post_assessment_status, certificate_id) VALUES
...
-- 8. Payments
INSERT INTO vi_payments (id, invoice_id, invoice_number, registration_id, participant_name, program_name, organization_name, amount, status, invoice_status, payment_method, payment_date) VALUES
...
-- 9. Certificates
INSERT INTO vi_certificates (id, registration_id, certificate_number, participant_email, participant_name, program_name, program_code, batch_name, trainer_name, completion_date, verification_status, score) VALUES
...
INSERT INTO vi_attendance_sessions (id, batch_id, session_title, session_date, start_time, end_time) VALUES
...
INSERT INTO vi_attendance_records (id, attendance_session_id, registration_id, batch_id, participant_name, participant_email, session_title, session_date, status, join_time, leave_time) VALUES
...
-- 12. Assessments
INSERT INTO vi_assessments (id, batch_id, program_id, assessment_type, title, description, passing_score, status) VALUES
...
INSERT INTO vi_assessment_questions (id, assessment_id, question_text, question_type, options, correct_answer, points) VALUES
  (
    'q1_pre_ai',
    'assess_pre_ai',
...
INSERT INTO vi_assessment_submissions (id, assessment_id, registration_id, participant_email, title, score, total_points, percentage, passed, status, answers) VALUES
...
-- 15. Feedback
INSERT INTO vi_feedback (id, registration_id, batch_id, batch_name, participant_name, participant_email, program_name, trainer_name, trainer_rating, material_rating, program_rating, satisfaction_score, comments) VALUES
